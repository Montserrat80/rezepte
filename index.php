...
require_once("php/functions/pfad_korrektur.php");
pfad_korrektur();
...
#no fem els require pq ara treballem amb namespace i a demés usem la funcio: spl_autoload_register, que s´executa automaticament el primer cop que creem una instancia d´una classe, en el moment que s´excuta el constructor. 
...
function eigener_loadFunktion($ordner_und_datei)
{
...
spl_autoload_register("eigener_loadFunktion"); 

##############################################################
#$navigation = new Navigation();
$navigation = new php\classes\Navigation();
##############################################################
?>